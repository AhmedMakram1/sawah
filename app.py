...
cred = credentials.Certificate("C:/Users/pc/Desktop/sawhtest-378ff-firebase-adminsdk-upmc1-9d41d6fbff.json")
firebase_admin.initialize_app(cred)
db=firestore.client()


# Load datasets
data = pd.read_csv('C:/project Details/Copyy.csv', encoding='latin-1')
hotels_data = pd.read_csv('C:/project Details/Hotels.csv')
